...
const buttonClassNames =
  "relative flex size-(--cell-size) text-xs items-center justify-center rounded-md text-foreground not-in-data-selected:hover:bg-accent disabled:pointer-events-none disabled:opacity-64 [&_svg:not([class*='opacity-'])]:opacity-80 [&_svg:not([class*='size-'])]:size-3.5 [&_svg]:pointer-events-none [&_svg]:shrink-0";
...
export function Calendar({
  ...
  const defaultClassNames = {
    ...
    caption_label:
      "text-xs font-medium flex items-center gap-1.5 h-full",
    day: "size-(--cell-size) text-xs py-px",
    day_button: cn(
      buttonClassNames,
    ...
    dropdown_root:
      "relative has-focus:border-ring has-focus:ring-ring/50 has-focus:ring-[3px] border border-input shadow-xs/5 rounded-md px-[calc(--spacing(2.5)-1px)] h-7 [&_svg:not([class*='opacity-'])]:opacity-80 [&_svg:not([class*='size-'])]:size-3.5 [&_svg]:pointer-events-none [&_svg]:-me-1",
    dropdowns:
      "w-full flex items-center text-xs justify-center h-(--cell-size) gap-1 *:[span]:font-medium",
    hidden: "invisible",
    month: "w-full",
    month_caption:
      "relative mx-(--cell-size) px-0.5 mb-0.5 flex h-(--cell-size) items-center justify-center z-2",
    months: "relative flex flex-col sm:flex-row gap-1",
    ...
    weekday:
      "size-(--cell-size) p-0 text-[0.65rem] font-medium text-muted-foreground/72",
  };
  ...
  const dayPickerProps = {
    className: cn(
      "w-fit [--cell-size:--spacing(7)] sm:[--cell-size:--spacing(6.5)]",
      className,
    ),
